...
public abstract class LuncheonCriterionTriggerBase<T extends LuncheonCriterionTriggerBase.Instance> implements CriterionTrigger<T> {

    public LuncheonCriterionTriggerBase(String id) {
        this.id = Luncheon.asResource(id);
    }

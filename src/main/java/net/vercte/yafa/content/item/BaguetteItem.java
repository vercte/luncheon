package net.vercte.yafa.content.item;
...
import net.vercte.yafa.content.registry.YAFAmisc;
...
import net.vercte.yafa.mixin.LivingEntityInvoker;
...
public class BaguetteItem extends SwordItem {
    ...
    public static final String BAGUETTE_MARKER = "yafaBaguette";

    public BaguetteItem(Properties properties) {
        super(YAFAmisc.BAGUETTE_TIER, 2, -2.4F, properties);
    }
    ...
    public static void holdingBaguetteIncreasesRange(LivingTickEvent event) {
        ...
        boolean holdingBaguette = YAFAItems.BAGUETTE.isIn(player.getMainHandItem());
    ...
    public static boolean isHoldingBaguette(Player player) {
        return YAFAItems.BAGUETTE.isIn(player.getMainHandItem());
    }
